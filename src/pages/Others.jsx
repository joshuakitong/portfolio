...
const sections = [
      ...
      <>
        ...
        <p>
          I began gaining informal work experience as early as elementary and high school, primarily as a <strong>Sound Technician </strong> 
           ...
           organizations like GDG Baguio, and had some early experience as a <strong>Developer</strong> building a Tuition Fee Tracking System for my elementary school.<br/><br/>
          
          Later on, while pursuing my creative careers in music and gaming, I also took on several part-time roles. I worked as 
           a <strong>Yarn Producer </strong> and <strong>Color Maker</strong> for our family-owned yarn business, a <strong>Transcriptionist</strong> for Insight 
           Asia, a <strong>Music</strong> and <strong>Gaming Mentor</strong> to artists and viewers, and more recently, a <strong>Cryptocurrency Trader</strong>.<br/><br/>

          These roles helped me sharpen key skills such as <strong>creativity</strong>, <strong>attention to detail</strong>, <strong>organization</strong>, <strong>communication</strong>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-6">
          This part may seem trivial, but it offers a glimpse into the things that keep me curious, creative, and both mentally and physically active outside of work.
        </p>
        ...
        <p className="mb-6">
          I enjoy watching a wide variety of shows — from dramas like Breaking Bad and Game of Thrones, to sitcoms like Curb Your Enthusiasm and The Big Bang Theory; from historical 
           ...
           like Rick and Morty and Adventure Time. Watching shows helps keep my mind active, inspired, and creatively engaged.
        </p>
        <h2 className="text-xl font-bold mb-2 tracking-wide text-gray-200">Games</h2>
        <p className="mb-6">
          Outside of competitive gaming and streaming, I also enjoy playing a variety of games during my free time. I expand my vocabulary with Scrabble, sharpen my 
        ...
        <p className="mb-6">
          I usually listen to music in the background while I work to keep myself energized and focused. My taste spans a wide range of genres — from hip-hop and EDM to rock, jazz, indie, and R&B. 
           I enjoy “<i>a little bit of everything all of the time</i>”, and love discovering new sounds, with too many favorite artists to name.
        </p>
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} transition={{ duration: 0.5 }} style={{ paddingBottom: '1rem' }} className="bg-texture min-h-screen">
      <div className="py-12 text-center">
        ...
        <p className="text-gray-400 mt-2 mx-2">Know more about me and my other work experiences.</p>
      </div>
