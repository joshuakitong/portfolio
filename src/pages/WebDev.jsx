  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-2">
          <div>
            <a href="https://joshuakitong.github.io/angular-to-do-app" target="_new" className="text-blue-400 hover:underline visited:text-purple-400">
          ...
          <div>
            <a href="https://flask-weather-app-k7b3.onrender.com" target="_new" className="text-blue-400 hover:underline visited:text-purple-400">
              <strong>Weather App</strong>
            </a><br/>
            <p className="ml-4 mr-4">
              A simple weather app built with <strong>Python</strong> and <strong>Flask</strong>, where users are able to search for the weather by city.<br/>
              <i className="text-xs text-gray-400">Note: The app may take a few seconds to load as it’s hosted on Render.com’s free tier.</i>
            </p>
            <a href="https://joshuakitong.github.io/react-tic-tac-toe" target="_new" className="text-blue-400 hover:underline visited:text-purple-400">
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} transition={{ duration: 0.5 }} style={{ paddingBottom: '1rem' }} className="bg-texture min-h-screen">
      <div className="py-12 text-center">
        ...
        <p className="text-gray-400 mt-2">Learn about my interest in computers and my experience as a web developer.</p>
      </div>
