  ...
  return (
    ...
    >
      ...
      <div className="text-gray-800 dark:text-gray-200 text-md sm:text-lg space-y-4 text-center mb-8">
        ...
        >
          I'm currently open to part-time roles or freelance opportunities where I can bring value with my full stack development skills. If you’re hiring, have a project in mind, or simply want to connect, feel free to reach out. You can also check out my links below for more info.
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <a
          ...
          className="flex gap-2 items-center text-sm sm:text-base bg-white/5 border border-black/15 dark:border-white/10 hover:bg-blue-500 hover:shadow-[0_0_8px_0_rgba(59,130,246,0.15)] rounded-full p-3 transition-colors duration-300 backdrop-blur-sm"
        >
